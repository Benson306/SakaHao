...
if(isset($_POST['ok_uni'])) {
	...
	<div class="col-md-offset-3 well well-sm">
		...
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Phone Number (Which You used to login)" name="phone_number" required="yes">
		</div>
		<div class="form-group">
...
<?php } else if($uni == 'KU'){ ?>
	...
	<div class="col-md-offset-3 well well-sm">
		...
		<div class="form-group">
			<label>Photo 2:</label>
			<input type="file" class="form-control" name="image2" required="yes"  >
		</div>
		
		<div class="form-group">
			<label>Photo 3:</label>
			<input type="file" class="form-control" name="image3" required="yes" >
		</div>
		<div class="form-group">
			<label>Photo 4:</label>
			<input type="file" class="form-control" name="image4"  required="yes">
		</div>
			<input type="submit" class="btn btn-danger" name="post">
		</form>
	</div>
...
if(isset($_POST['post'])){
	...
	$image_sql = "INSERT INTO landlord_post (apartment_name, house_type, location, phone_number, phone_number2, rent_amount, rent_deposit, water_deposit, elec_deposit, garbage, security, water_avai, distance, directions, image1_name, image1, image2_name, image2, image3_name, image3, image4_name, image4)  VALUES('$apart', '$house_type', '$location', '$phone_number', '$phone_number2', '$rent_amount', '$rent_deposit', '$water_deposit', '$elec_deposit', '$garbage', '$security', '$water_avai', '$distance', '$directions', '$imageName', '$imageData', '$image2Name', '$image2Data', '$image3Name', '$image3Data', '$image4Name', '$image4Data') "; 
