...
<center>
	<h4>Tenant Login and registration Panel </h4>
</center>
...
<div class="col-md-9">
	<div class="col-md-offset-3 well well-sm">
		<form action="tenant_login_verification.php" method="post">
		...
		<input type="submit" name="submit" class="btn btn-success"  >
			...
			<br>
			<br>
			<a href="T_registration.php"><button class="btn btn-muted">New user?Click here!!</button></a>
	</div>
