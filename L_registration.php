...
if(isset($_POST['register'])){
	...
	$check_sql = "SELECT * FROM landlord_registration WHERE  phone_number = '$phone_number' ";
	$result = mysqli_query($conn, $check_sql); 
	$count= mysqli_num_rows($result);

	$ins_sql = "INSERT INTO landlord_registration (username, phone_number, email, password, TCs )  VALUES('$username', '$phone_number', '$email', '$password', '$TC') ";
